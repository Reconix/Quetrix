...
// multiple on scroll functions
  ...
  function scrollFunction() {
    ...
    // get element by class name and set array index
    ...
    const navLogin = document.getElementsByClassName("btn-login")[0];
    const navSignup = document.getElementsByClassName("btn-sign-up")[0];
    ...
    if (document.body.scrollTop > 380 || document.documentElement.scrollTop > 380) {
      ...
      navLogin.style.transition = "all 0.5s";
      navSignup.style.fontSize = "14px";
      navSignup.style.padding = "5px 17px 5px 17px";
      navSignup.style.transition = "all 0.5s";
    }

  }

  // Back to top button
  window.addEventListener("scroll", function goingUp(e) {
